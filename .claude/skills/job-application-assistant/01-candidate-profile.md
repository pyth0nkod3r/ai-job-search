...
- **Location:** Port Harcourt, Nigeria (open to relocation)
- **Phone:** +2347034323113
- **Email:** mac.mkboy1@gmail.com
- **LinkedIn:** https://linkedin.com/in/macmkboy
- **GitHub:** https://github.com/pyth0nkod3r
- **Status:** Open to offers
- **Constraints:** Willing to relocate; open to remote or on-site
...
|--------|--------|-------------|------------|
| BEng Electronic and Computer Engineering | (start - end TBD; final year research 2018) | Nnamdi Azikiwe University, Awka, Anambra, Nigeria | Embedded systems, sensor integration, signal processing, ultrasonic sensing, network infrastructure |
...
- Carrying out API testing and integration for the company's fintech product, validating released endpoints against the frontend to confirm every expected field is captured and accurately processed before reaching the database.
...
### Frontend Developer Intern — Sand Technologies
**Location:** Remote — San Francisco, CA, USA *(via ALX Ventures Partnership)*
...
- Three-month internship through ALX Ventures.
...
### Agentic Next.js App Builder (Egoras / cube-os)
- See "Professional Experience → Egoras" above. Built inside the cube-os product; backend takes a natural-language prompt and produces a working Next.js application (full-stack or single-side).
...
- Admin login, view registered teams / user messages / partnership requests, download user registration data as PDF or CSV, respond to user messages.
...
- **JavaScript** — fluent
- **React** — fluent
- **Python** — fluent (specialization, see Certifications)
- **Django / DRF** — fluent
- **MySQL / PostgreSQL** — fluent
- **SQL / T-SQL** — working proficiency
- **Git / GitHub** — fluent (active contributor)
- **Linux / WSL** — comfortable
- **Docker** — working proficiency
- **Kestra / Airflow** — working proficiency (data pipeline orchestration)
- **Streamlit** — working proficiency
- **Microsoft Azure / AWS** — foundational (Azure Data + AI Fundamentals certified)
- **CI/CD (GitHub Actions)** — working proficiency
- **Coolify** — working proficiency (self-hosting)
- **OOP** — fluent
...
| Project Management certification (CIPMN, via ITF's SUPA programme) | Chartered Institute of Project Managers of Nigeria (CIPMN) — issued through the Industrial Training Fund's Skill-Up Artisans (SUPA) programme, which included project management among its courses | TBD | Registration No. SUPA/NO.08972 |
...
- The "willing to relocate + open to offers" + "builds end-to-end" + "carries both engineering and software" combination is unusual and is the differentiator. Lean into "full-stack with embedded/hardware exposure" framing for software roles, and into "software engineer with telecom and NDT field experience" for hardware-adjacent roles.
- Cross-discipline markers (UTG, P&ID, BTS) are evidence of operating in physical-infrastructure environments, not filler. They should be on the CV when the role benefits, omitted (but in the profile) when irrelevant.
- The Egoras agentic work is the strongest current differentiator in the market. Frame as "built, not used" — owns the implementation.
- GFA is part-time / contract. Always label as such. The 80% bundle cut is the strongest quantified achievement in the profile.
- Spanish and German are beginner-only. The Language Gate will flag any posting that requires them. Do not auto-reject — surface to the user.
