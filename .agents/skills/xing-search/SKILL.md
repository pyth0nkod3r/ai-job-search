...
attribution: "Adapted from rasstamann/ai-job-search-germany (XING portal skill, personal-use only per upstream ToS notes). cli.ts, commands/search.ts, commands/detail.ts, src/helpers.ts, url-reference.md are unmodified from upstream. Added local package.json, tsconfig.json, and tests/cli.test.ts."
---
